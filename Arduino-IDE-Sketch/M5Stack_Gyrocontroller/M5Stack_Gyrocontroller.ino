...
int cc74, bcc74, cc71, bcc71, cc1, bcc1;
...
void loop()
{
  ...
  if (IMU.readByte(MPU9250_ADDRESS, INT_STATUS) & 0x01)
  {
    ...
    cc74 = map(IMU.ax * 100, -100, 100, 127, 0);
    cc71 = map(IMU.ay * 100, -100, 100, 127, 0);
    cc1 = map(IMU.az * 100, -100, 100, 0, 127);

    if (bcc74 != cc74) {
      MIDI.sendControlChange(74, cc74, 1);
      bcc74 = cc74;
    }
    if (bcc71 != cc71) {
      MIDI.sendControlChange(71, cc71, 1);
      bcc71 = cc71;
    }
